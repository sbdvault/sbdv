              ...
              <div key={app.id} className="p-6 bg-white border border-charcoal/10 rounded-lg">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <p className="font-heading font-medium">{app.termYears} {t("capitalAccess.request.years")}</p>
                  </div>
                  <div>
                ...
                {app.status === "APPROVED" && (
                  <Link
                    href={getLocalizedHref("/capital-access/portal/facility")}
                  ...
                  >
                    {t("capitalAccess.onboarding.beginOnboarding")} →
                  </Link>
                )}
              </div>
            );
